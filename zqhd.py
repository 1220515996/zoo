...
# -- coding: utf-8 --
"""
打开小程序或APP-我的-积分, 捉以下几种url之一,把整个url放到 tokens 里,多账号换行分割
...
class RUN:
    ...
    def Autumn_2024_index(self):
        ...
        try:
            ...
            self.headers[
                'referer'] = f'https://mcs-mimp-web.sf-express.com/origin/a/mimp-activity/midAutumn2024?mobile={self.mobile}&userId={self.user_id}&path=/origin/a/mimp-activity/midAutumn2024&supportShare=&inviteUserId=5426183ED37849D996A65F2377E30E28&from=24zqxcx'
            payload = {}
...
if __name__ == '__main__':
    ...
    tokens = [
        #类似下边，替换
        'https://mcs-mimp-web.sf-express.com/mcs-mimp/share/weChat/activityRedirect?source=CX&unionId=QmuGSH9yvimz%2FSgruozRKA3bkbYbWzs721%22%7D'
    ]
