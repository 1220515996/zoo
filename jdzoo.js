...
$.cookie = '';
$.inviteList = [];
$.list = ["sSKNX-MpqKPS4rS-npPQDYOlFyDzCyhRYtxWZkNYIjNWBEuDByCGnQjA20ol0D6w","sSKNX-MpqKOAsue5m5jcax47exVx0YtcpD9MBRLXtf6goOkD_Bc0","sSKNX-MpqKOJsNvb8ceEZVZmTGy4zEMzMyeSFu9qrBsznRqya_aF-rY56ux0jg","sSKNX-MpqKOJsNu8ms3dAdn8VNTP8kzVhtIRoYEsolkYOn8PV91GXBmUal4vEZEV"];
$.pkInviteList = [];
$.secretpInfo = {};
$.innerPkInviteList = [];
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        if (new Date().getHours() >= 9) {
            console.log(`\n******开始内部京东账号【怪兽大作战pk】助力*********\n`);
            for (let i = 0; i < $.list.length && pKHelpFlag && $.canHelp; i++) {
